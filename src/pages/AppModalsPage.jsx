    ...
    <div className="px-4 md:px-6 py-4 flex flex-col gap-4">
      <div className="bg-white rounded-xl border border-[#e8ddd0] p-6 flex flex-col gap-5">
        <h3 className="font-bold text-[#3a2a1a] text-sm flex items-center gap-2">
          <AlertTriangle className="w-4 h-4 text-[#8B6914]" /> App Modals Configuration
        </h3>
        <p className="text-xs text-[#9a8a7a]">
          Manage dynamic modals that appear in the mobile application. Ensure active status is updated to prompt users.
        </p>
              ...
              <div key={modal._id} className="border border-[#e8ddd0] rounded-xl p-5 bg-[#fcfaf7] flex flex-col gap-4 shadow-sm">
                <div className="flex justify-between items-center border-b border-[#e8ddd0] pb-3">
                  <h4 className="font-bold text-[#3a2a1a] text-base capitalize flex items-center gap-2">
                    {modal.type === "region_department" ? "Region & Department" : modal.type} Modal
                  </h4>
                  <div 
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-bold text-[#9a8a7a] uppercase tracking-wider">Title</label>
                  <input 
                    type="text"
                    value={modal.title || ""}
                    onChange={(e) => {
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-bold text-[#9a8a7a] uppercase tracking-wider">Description</label>
                  <textarea 
                ...
                {modal.type === "update" && (
                  <div className="flex flex-col gap-4 mt-2 border-t border-[#e8ddd0] pt-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-[10px] font-bold text-[#9a8a7a] uppercase tracking-wider">Target Platform</label>
                      <select 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                      ...
                      {(modal.platform === "all" || modal.platform === "ios") && (
                        <div className="flex flex-col gap-3 bg-[#f5f0e8] p-3 rounded-lg border border-[#e8ddd0]">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-xs font-bold text-[#3a2a1a]">iOS Configuration</span>
                          </div>
                          <div className="flex flex-col gap-1.5">
                            <label className="text-[9px] font-bold text-[#9a8a7a] uppercase tracking-wider">Min iOS Version</label>
                            <input 
                              type="text"
                          ...
                          <div className="flex flex-col gap-1.5">
                            <label className="text-[9px] font-bold text-[#9a8a7a] uppercase tracking-wider">App Store Link</label>
                            <input 
                              type="url"
                      ...
                      {(modal.platform === "all" || modal.platform === "android") && (
                        <div className="flex flex-col gap-3 bg-[#f5f0e8] p-3 rounded-lg border border-[#e8ddd0]">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-xs font-bold text-[#3a2a1a]">Android Configuration</span>
                          </div>
                          <div className="flex flex-col gap-1.5">
                            <label className="text-[9px] font-bold text-[#9a8a7a] uppercase tracking-wider">Min Android Version</label>
                            <input 
                              type="text"
                          ...
                          <div className="flex flex-col gap-1.5">
                            <label className="text-[9px] font-bold text-[#9a8a7a] uppercase tracking-wider">Play Store Link</label>
                            <input 
                              type="url"
