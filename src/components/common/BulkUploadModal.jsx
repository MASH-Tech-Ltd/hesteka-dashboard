        ...
        <div className="p-6">
          {results ? (
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-center text-xl font-black text-[#3a2a1a]">
                Upload Complete!
              </h3>
              ...
              {results.errors && results.errors.length > 0 && (
                <div className="bg-red-50/50 p-3 rounded-xl border border-red-100 max-h-32 overflow-y-auto custom-scrollbar mt-4">
              ...
              {results.warnings && results.warnings.length > 0 && (
                <div className="bg-yellow-50/50 p-3 rounded-xl border border-yellow-100 max-h-32 overflow-y-auto custom-scrollbar mt-4">
                  <h4 className="text-xs font-bold text-yellow-800 mb-2 flex items-center gap-1">
                    <AlertCircle className="w-3 h-3" /> Warnings
                  </h4>
                  <ul className="text-[10px] text-yellow-700 list-disc pl-4 flex flex-col gap-1">
              ...
              >
                ...
                {selectedFile ? (
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-black text-[#3a2a1a]">
                        {selectedFile.name}
                      </p>
