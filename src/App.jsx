...
const ValidationDonationsPage = lazy(
  () => import("./pages/ValidationDonationsPage"),
);
          ...
          fallback={
            <div className="flex h-screen w-screen items-center justify-center bg-[#fcfaf7]">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-[#8B6914] font-bold tracking-widest uppercase text-xs animate-pulse">
                  Loading Application...
                </p>
              </div>
            </div>
        ...
        >
          <Routes>
            ...
            <Route
              path="/"
              element={
                <Navigate to={isAdmin() ? "/dashboard" : "/login"} replace />
              }
            />
            ...
            >
              ...
              <Route
                ...
                element={<ValidationDonationsPage />}
              />
              <Route
